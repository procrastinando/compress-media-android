...
cat > "$BOOT_SCRIPT" << 'EOF'
#!/data/data/com.termux/files/usr/bin/bash
# Start the compressor in the background to free up the boot process.
...
echo "Modify the config file at '~/compress-media-android/config.yaml' to change settings."
